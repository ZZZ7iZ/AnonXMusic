...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/H_M_Dr) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/H_M_Dr) /AFYN \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/H_M_Dr)\n [ᖴ᥆ᖇ ᥲ️ᖇꪀ᥆ρ. 🐰](https://t.me/H_M_Dr)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/H_M_Dr) """,
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/H_M_Dr) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/H_M_Dr) \n ※[These Features AI Based](https://t.me/H_M_Dr)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
